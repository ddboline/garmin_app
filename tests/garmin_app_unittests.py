...
class TestGarminApp(unittest.TestCase):
    ...
    def test_garmin_day_average_report_txt(self):
        ...
        gsum.read_file()
        gr = garmin_report.GarminReport()
        output = gr.day_average_report_txt(gsum, sport='running',
                                           number_days=1)
        mstr = hashlib.md5()
        mstr.update(output)
    ...
    def test_garmin_week_average_report_txt(self):
        ...
        gsum.read_file()
        gr = garmin_report.GarminReport()
        output = gr.week_average_report_txt(gsum, sport='running',
                                            number_of_weeks=1)
        mstr = hashlib.md5()
        mstr.update(output)
    ...
    def test_garmin_month_average_report_txt(self):
        ...
        gsum.read_file()
        gr = garmin_report.GarminReport()
        output = gr.month_average_report_txt(gsum, sport='running',
                                             number_of_months=1)
        mstr = hashlib.md5()
        mstr.update(output)
    ...
    def test_garmin_cache_get_summary_list(self):
        ...
        output = (
            '\n'.join(
                '%s' % s for s in sorted(sl, key=lambda x: x.filename)))\
